...
function SupabaseIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="16" width="16" className="shrink-0">
      <path fill="url(#supabase-gradient)" d="M13.89 20.862c-.45.716-1.545.362-1.545-.5V11.85h8.168c.933 0 1.433 1.094.831 1.818l-10.89 13.09c-.45.716-1.545.362-1.545-.5V17.75H1.741c-.933 0-1.433-1.094-.831-1.818L11.8.842c.45-.716 1.545-.362 1.545.5v8.512h8.168c.933 0 1.433 1.094.831 1.818l-8.454 9.19Z"/>
      <defs>
        <linearGradient id="supabase-gradient" x1="12" y1="0" x2="12" y2="24" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3ECF8E"/>
          <stop offset="1" stopColor="#3ECF8E" stopOpacity="0.6"/>
        </linearGradient>
      </defs>
    </svg>
  );
...
export function Footer({ machineMode = false, onChangelogClick }: FooterProps) {
  if (machineMode) return null;

  return (
    <footer className="hidden md:block fixed bottom-0 left-0 right-0 z-10 border-t border-gray-200/40 bg-white/30 backdrop-blur-sm md:left-16">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 py-4">
        <div className="flex items-center justify-between gap-3 text-xs text-gray-600">
          {/* Bloque izquierdo - Copyright y proyecto */}
          <div className="flex items-center gap-2">
            ...
            <span>Non-profit community project</span>
          </div>

          {/* Bloque derecho - Made with love + Enlaces */}
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1">
              <span>Made with</span>
              <Heart className="w-3 h-3 text-red-500 fill-red-500" strokeWidth={2} />
              <span>in Madrid with</span>
              <FigmaMakeIcon />
              <span className="font-medium">Figma Make</span>
              <span>and</span>
              <SupabaseIcon />
