import svgPaths from "./svg-iyb3agfmgh";
  ...
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path clipRule="evenodd" d={svgPaths.p1905f5f0} fill="var(--fill-0, #0250D9)" fillRule="evenodd" id="Icon_2" />
        </g>
      </svg>
    </div>
  );
...
function AgenticCard() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] h-[240px] isolate items-start left-[17px] top-[17px] w-[396px]" data-name="✨ Agentic Card">
      <Card />
      <AfCardShadow />
    </div>
  );
